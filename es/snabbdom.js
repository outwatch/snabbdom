...
export function init(modules, domApi) {
    ...
    function createElm(vnode, insertedVnodeQueue) {
        ...
        if (sel === '!') {
            ...
            var elm = vnode.elm = isDef(data) && isDef(i = data.ns) ? api.createElementNS(i, sel)
        ...
        while (oldStartIdx <= oldEndIdx && newStartIdx <= newEndIdx) {
            if (oldStartVnode == null) {
                ...
                if (newStartVnode.elm == oldStartVnode.elm) {
                    ...
                    idxInOld = findIndex(oldCh, oldStartIdx + 1, oldEndIdx - 1, function (x) { return isDef(x) && newStartVnode.elm == x.elm; });
                    if (idxInOld == -1) {
                ...
                if (newEndVnode.elm == oldEndVnode.elm) {
                    ...
                    idxInOld = findIndexRev(oldCh, oldStartIdx + 1, oldEndIdx - 1, function (x) { return isDef(x) && newEndVnode.elm == x.elm; });
                    if (idxInOld == -1) {
